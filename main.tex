...
Finally, this paper does not directly address DeduceIt's effect on teaching outcomes: how the system compares with traditional educational tools, and how it impacts student learning. However, the student feedback we collected was promising:

\begin{itemize}
  \item ``I found the DeduceIt exercise \textit{especially} helpful in getting a better handle on the material. Being able to step through the parsing actions and `be' the parser and know immediately when I made a mistake was incredibly helpful in coming to truly understand how the different parsing styles work. So... thanks a lot for that! I seriously hope you guys continue to make use of DeduceIt as a learning tool in future endeavors.''
  \item ``The first thing I thought when I started working on any DeduceIt problems was `Man, I wish this was a tool my university used.' I've found that it made a lot of sense to use it to walk through the process of parsing things and have immediate feedback when you were looking at it wrong.''
\end{itemize}

We hope to study learning outcomes in future work.
